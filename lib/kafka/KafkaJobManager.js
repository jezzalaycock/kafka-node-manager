...
var KafkaJobManager = function (job, zk, clientId, topic, messageCount, notifySuccess, notifyFailure, deadLetterTopic) {
    this.job = job;
    this.zk = zk;
...
KafkaJobManager.prototype.excute = function () {
    ...
    this.consumer.on('message', function (message) {
        var messageId = self.messageManager.addMessageMapping(self.clientId, message.topic, message.partition);
        messagesRead++;
...
KafkaJobManager.prototype.initialise = function () {
    ...
    this.consumer = new Consumer(this.client, [
        { topic: this.topic }
    ], {groupId: this.clientId, autoCommit: false, paused:true, maxTickMessages: 100, fetchMaxBytes: 1024 * 1024});
